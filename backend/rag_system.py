...
from search_tools import ToolManager, CourseSearchTool, CourseListTool, CourseOutlineTool
...
class RAGSystem:
    ...
    def __init__(self, config):
        ...
        self.tool_manager.register_tool(CourseListTool(self.vector_store))
